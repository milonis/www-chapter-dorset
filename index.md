...
#### TALKS:
##### An Introduction to OWASP - Daniel Warden
An introduction to OWASP what it does and how to make use of some of it's resources
##### Making use of OWASP resources: Cheat sheets - Mark Davison
##### Routes to becoming a Penetration Tester - James Riley
A talk about the ways people come to penetration testing and how what you expect may not always be true.
##### AppSec 101 - Mike Warner
...
#### TALKS:
##### A whistle stop guide to preparing yourself for the OSCP -Mark Davison 
(Offensive Security Certified Professional) certification
from a recent graduate.

##### Mining data dumps and leaks for treasure and passwords.
 Complexity and statistical data gathered from research conducted at Bournemouth University.
##### FEEDBACK: 
...
#### TALKS:
##### OWASP Dorset Introduction
Welcome, news and an update on OWASP Projects & Events from the OWASP Dorset Chapter Leader.
